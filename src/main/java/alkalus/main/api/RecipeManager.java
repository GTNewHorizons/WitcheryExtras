...
public class RecipeManager {
    ...
    public static class WitchesOven {
         ...
         */
        public static synchronized boolean addRecipe(
                ...
                final int amt2) {
            return WitcheryRecipeHandlerInternal.addOvenRecipe(
                    input1, inputString1, jars, customOutput, amt1, outputJarStack, amt2);
        }
    ...
    public static class Distillery {
        ...
        public static synchronized boolean addRecipe(
                ...
                ItemStack output3,
                ItemStack output4) {
            return WitcheryRecipeHandlerInternal.addDistilleryRecipe(
                    input1, input2, jars, output1, output2, output3, output4);
        }
        ...
        public static synchronized DistilleryRecipe getDistillingResult(
                ItemStack input1, ItemStack input2, ItemStack jars) {
    ...
    public static class Kettle {
        ...
        public static synchronized boolean addRecipe(
                ...
                boolean inBook,
                ItemStack... inputs) {
            return WitcheryRecipeHandlerInternal.addKettleRecipe(
                    output, hatBonus, familiarType, powerRequired, color, dimension, inBook, inputs);
        }
    ...
    public static class RitesAndRituals {
        ...
        public static synchronized boolean add(
                ...
                Circle... circles) {
            return WitcheryRecipeHandlerInternal.addNewRiteToRiteRegistry(
                    ritualID, bookIndex, rite, initialSacrifice, traits, circles);
        }
